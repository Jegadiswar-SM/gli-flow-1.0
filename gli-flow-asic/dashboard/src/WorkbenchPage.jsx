...
function FileTreePanel({ params }) {
  const { tree, onOpen, onRefresh } = params
...
function EditorPanel({ params }) {
  const { file, onChange, onSave, dirty } = params
...
export default function WorkbenchPage() {
  ...
  const changeFile = useCallback(content => { setFile(previous => ({ ...previous, content })); setDirty(true) }, [])
